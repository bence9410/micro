...
public class Constants {
	...
	public static final String AMUSEMENT_PARK_URL = BASE_URL + "/amusement-park";
	...
	public static final String ENTER_PARK_URL = AMUSEMENT_PARK_URL + "/{amusementParkId}/visitor/{visitorId}/enter-park";
	public static final String PAGED_AMUSEMENT_PARK_URL = AMUSEMENT_PARK_URL + "/paged";
	public static final String GET_ON_MACHINE_URL = MACHINE_URL + "/{machineId}/visitor/{visitorId}/get-on-machine";
	public static final String GET_OFF_MACHINE_URL = MACHINE_URL + "/{machineId}/visitor/{visitorId}/get-off-machine";
	public static final String ADD_GUEST_BOOK_REGISTRY = AMUSEMENT_PARK_URL + "/{amusementParkId}/visitor/{visitorId}/guest-book-registry";
	public static final String LEAVE_PARK_URL = AMUSEMENT_PARK_URL + "/{amusementParkId}/visitor/{visitorId}/leave-park";
