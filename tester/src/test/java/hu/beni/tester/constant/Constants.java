...
public class Constants {
	...
	public static final String ENTER_PARK_URL = AMUSEMENT_PARK_URL
			+ "/{amusementParkId}/visitor/{visitorId}/enter-park";
	...
	public static final String ADD_GUEST_BOOK_REGISTRY = AMUSEMENT_PARK_URL
			+ "/{amusementParkId}/visitor/{visitorId}/guest-book-registry";
	public static final String LEAVE_PARK_URL = AMUSEMENT_PARK_URL
			+ "/{amusementParkId}/visitor/{visitorId}/leave-park";
